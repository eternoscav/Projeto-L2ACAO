...
<div id="wrap">
	...
	<div id="page-header">
		<div class="headerbar">
          ...
          <div class="menu-block" style="float: <?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>; width: 19%;">
             <div class="menu-row-first"><a class="left menu-link" href="#">Your Link</a></div>
             <div class="menu-row-first"><a class="left menu-link" href="#">Your Link</a></div>
             <div class="menu-row-first"><a class="left menu-link" href="#">Your Link</a></div>
             <div class="menu-row-first"><a class="left menu-link" href="#">Your Link</a></div>
             <div class="menu-row-first"><a class="left menu-link" href="#">Your Link</a></div>			 
             <div class="menu-row"><a class="left menu-link" href="<?php echo (isset($this->_rootref['U_SEARCH'])) ? $this->_rootref['U_SEARCH'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_SEARCH_ADV_EXPLAIN'])) ? $this->_rootref['L_SEARCH_ADV_EXPLAIN'] : ((isset($user->lang['SEARCH_ADV_EXPLAIN'])) ? $user->lang['SEARCH_ADV_EXPLAIN'] : '{ SEARCH_ADV_EXPLAIN }')); ?>"><?php echo ((isset($this->_rootref['L_SEARCH_ADV'])) ? $this->_rootref['L_SEARCH_ADV'] : ((isset($user->lang['SEARCH_ADV'])) ? $user->lang['SEARCH_ADV'] : '{ SEARCH_ADV }')); ?></a></div>	
			 <br />
		...
		<?php } ?>
          ...
          <div style="float: <?php echo (isset($this->_rootref['S_CONTENT_FLOW_BEGIN'])) ? $this->_rootref['S_CONTENT_FLOW_BEGIN'] : ''; ?>; width: 79.5%;">			
