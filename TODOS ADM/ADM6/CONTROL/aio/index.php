...
<table width="1009" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div align="left"><img src="../imagens/logo.png" border="0" alt="Logo Stronger"><br><a href="../index.php">Atras</a></div></td>
  </tr>
</table>
<table width="100%" border="0">
  <tr bgcolor="#CCCCCC" class="style1">
    <td align="center"><div align="left">Admin Panel v.1 - Sistema de AIO:</div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<form id="form1" name="form1" method="post" action="">
  <table width="100%" border="0" class="style2">
    <tr>
      <td width="21%">Selecione un Player:</td>
    ...
    <tr>
      <td>Alterar level de un personaje: </td>
      <td colspan="3"><input name="level" type="text" class="style2" id="level" value="78" /></td>
    </tr>
    <tr>
      <td height="23">Enchantar un personaje? </td>
      ...
      Si</td>
      <td width="10%" height="23"><input name="dual" id="dual" type="radio" class="style2" value="não" onclick="javascript:div('enchant');">
      No</td>
      <td width="58%" height="23">
      <div id="enchant" style="display:block">
      <input name="enchant" type="text" class="style2" id="enchant" onmouseup="javascript:mudar('enchant');" value="Escriva aqui el enchant para el arma." size="40"/> 
        EX: <strong>10</strong>
        </div>
      </td>
    </tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td colspan="3"><input name="inserir" type="submit" class="style2" id="inserir" value="Acceptar" /></td>
    </tr>
  </table>
</form>
<?
...
<table width="100%" border="0">
  <tr>
    <td><a href="?act=abx" class="style4">- Cambiar level y/o enchant a un personaje.</a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
