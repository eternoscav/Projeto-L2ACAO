...
<table width="1009" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div align="left"><center>
      <div align="center"><a href="www.l2haze.com" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','../imagens/2.png',1)"><img src="../imagens/1.png" alt="Aio" name="Image1" width="282" height="101" border="0" id="Image1" /></a><br>
        <a href="../index.php"><strong>Voltar</strong></a></div>
    </div></td>
  </tr>
</table>
...
<form id="form1" name="form1" method="post" action="">
  <table width="100%" border="0" class="style2">
	...
	?>
          <option value="<?php echo $c['char_Id']; ?>"><?php echo $c['char_name']; ?></option>
          <?
	}
	?>
        </select>      </td>
...
$chars = mysql_query("SELECT * FROM characters WHERE char_Id = '".$char."'") or die(mysql_error());
