...
<table width="100%" border="0">
  <tr bgcolor="#CCCCCC" class="style1">
    <td align="center"><a href="www.l2haze.com" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','../../imagens/2.png',1)"><img src="../../imagens/1.png" alt="Aio" name="Image1" width="282" height="101" border="0" id="Image1" /></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
