...
<title>Lineage 2 Painel Admin</title>
<script><!--
...
<body link="#00000" vlink="#00000" alink="#00FF00" onload="MM_preloadImages('imagens/2.png')">
<strong><h2 class="style1">Painel Admin L2 Haze</h2>
</strong>
<table width="700" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="200" align="center" valign="top"><a href="www.l2haze.com" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','imagens/2.png',1)"><img src="imagens/1.png" alt="L2 Haze" name="Image1" width="282" height="101" border="0" id="Image1" /></a></td>
