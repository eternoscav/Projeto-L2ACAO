...
<table width="700" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="200" align="center" valign="top"><img src="imagens/logo.png" width="800" height="372" alt="Logo" /></td>
    <td width="487" align="center" valign="middle"><table width="129" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="129" height="37" align="center" valign="middle" id="tabela"><a href="aio/index.php">Cambiar Lvl  Cambiar Enchant</a></td>
      </tr>
      <tr>
        <td width="129" height="37" align="center" valign="middle" id="tabela"><a href="donacion/index.php">Donaciones</a></td>
      </tr>
      <tr>
        <td width="129" height="37" align="center" valign="middle" id="tabela"><a href="drop/drop.php">Calculador de drop</a></td>
      </tr>
      <tr>
        <td width="129" height="37" align="center" valign="middle" id="tabela"><a href="heroes/heroes.php">Heroes</a></td>
      </tr>
      <tr>
        <td width="129" height="37" align="center" valign="middle" id="tabela"><a href="players/players.php">Lista de players</a></td>
      </tr>
      <tr>
       <td width="129" height="37" align="center" valign="middle" id="tabela"><a href="rank/select.php">Rankings</a></td>
      </tr>
      <tr>
       <td width="129" height="37" align="center" valign="middle" id="tabela"><a href="ids/ids.php">Id's</a></td>
      </tr>
      <tr>
        <td width="129" height="37" align="center" valign="middle" id="tabela"><a href="Registro/Registro.php">Registro</a></td>
      </tr>
      <tr>
       <td width="129" height="37" align="center" valign="middle" id="tabela"><a href="chars/index.php">Players<br>On / Jail / Ban</a></td>
      </tr>
            <tr>
       <td width="129" height="37" align="center" valign="middle" id="tabela"><a href="castle/index.php">Castillos</a></td>
      </tr>
    </table></td>
...
$sql4 = mysql_query("SELECT online FROM characters WHERE online = 1 AND accesslevel = 300");
$contagem4 = mysql_num_rows($sql4);

$sql5 = mysql_query("SELECT online FROM characters WHERE online = 1 AND accesslevel = 200");
$contagem5 = mysql_num_rows($sql5);

echo "<br>*-<font color='C8B560' size='2'><strong>Cuentas: </strong></font><font color='#008000'><font size='1'>$contagem1</font></font>";
echo "<br>*-<font color='C8B560' size='2'><strong>Personajes Creados: </strong></font><font color='#008000'><font size='1'>$contagem2</font></font>";
...
echo "<br>*-<font color='C8B560' size='2'><strong>Personajes Online: </strong></font><font color='#008000'><font size='1'>$contagem3</font></font><br>";
// Login Server
...
size='1' face='verdana' color='#0066FF'>Status:</font><font color='red' size='1' face='verdana'> Offline</font>$downmessage"; }
...
face='verdana'><strong>Gameserver</strong></font><br><font size='1' face='verdana' color='#0066FF'>Estado:</font><font 
