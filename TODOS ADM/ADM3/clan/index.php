...
<?php
	include "../config.php";
	$sql = mysql_query("SELECT * FROM clan_data ORDER BY clan_level DESC")or die(mysql_error());
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#000000">
  <tr>
    ...
    <td width="16%" align="center" valign="middle" bgcolor="#999999">Add Reputação</td>
    <td width="17%" align="center" valign="middle" bgcolor="#999999">Add Level</td>
  </tr>
  <?php
  ...
  <tr bgcolor="<? echo $bg; ?>">
   ...
   ?>
    ...
    <td align="left" valign="middle"><form id="form1" name="form1" method="post" action="addreputa.php?id=<?=$linha['clan_id'];?>">
      <input name="reputation_score" type="text" id="reputation_score" size="8" maxlength="8" />
      <input type="submit" name="button" id="button" value="Add " />
    </form></td>
    <td align="left" valign="middle"><form id="form1" name="form1" method="post" action="addlevel.php?id=<?=$linha['clan_id'];?>">
      <input name="clan_level" type="text" id="clan_level" size="8" maxlength="8" />
      <input type="submit" name="button" id="button" value="Add " />
    </form></td>
  </tr>
  <?php
