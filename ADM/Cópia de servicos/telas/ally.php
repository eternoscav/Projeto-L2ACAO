<form action="./index.php?t=ally.php" method="POST">
Localizar Ally:
				<input type="text" name="allyName" >
				<input type="submit" value="Localizar"></form>
				<br />
				<a href="./index.php?t=allyCreate.php">Criar Ally</a><br />
...
echo "<table width=\"100%\" border=\"0\">
  <tr class=\"style2\">
  <td align=\"center\"><a href=\"./index.php?t=ally.php\">Total de Allyes no Servidor: <strong>{$contarALL} <br></a></strong>
		</td></tr>
</table>";
}
else
...
echo $contarALLclansally;			  
		echo "<td><form action=\"./index.php?t=allydetails.php\" method=\"POST\">
