<form action="./index.php?t=clans.php" method="POST">
       ...
       $cor= $cor == 'c0c0c0' ? 'f0f0f0' : 'c0c0c0';
		...
		if (mysql_num_rows($olly))
		 ...
		 <td>{$dato['ally_name']}</td>";
			  echo "<td><form action=\"./index.php?t=detalhesclan.php\" method=\"POST\">
...
{
echo "<br><b>Nenhum Clan localizado!</b><br><br><a href=\"./index.php?t=clans.php\">Voltar</a></b>";
}
}
else
{
echo "<br><b>Nenhum Clan localizado!<br><br><a href=\"./index.php?t=clans.php\">Voltar</a></b>";
}
?>
