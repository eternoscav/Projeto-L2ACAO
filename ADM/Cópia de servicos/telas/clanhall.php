...
\"style15
\" bgcolor=\"{$bg}\">
    <td align=\"center\"><form action=\"./index.php?t=kickoffclanhallsave.php\" method=\"POST\"> {$c['name']}
    ...
    <td align=\"center\"><form action=\"./index.php?t=detalhesclan.php\" method=\"POST\">
	{$c['clan_name']}
...
\" bgcolor=\"{$bg}\">
    ...
    <td align=\"center\"><form action=\"./index.php?t=giveclanhall.php\" method=\"POST\">
