<form action="./index.php?t=conschars.php" method="POST">
...
echo "<table width=\"100%\" border=\"0\">
  <tr class=\"style2\">
  <td align=\"center\"><a href=\"./index.php?t=allchars.php\">Total de Chars no Servidor: <strong>{$contarALL} <br></a></strong>
		</td></tr><tr><td><br></td></tr><tr>
    <td align=\"center\"><a href=\"./index.php?t=chars.php\">Chars Online no Servidor: <strong>{$contarON}</strong></td></tr>
</table>";
}
else
{
...
$querycheckconsulta = "SELECT * FROM characters WHERE online='1' AND char_name LIKE '%".$_POST['nomeChar']."%'";
...
$query = "SELECT * FROM characters WHERE online='1' AND char_name LIKE '%".$_POST['nomeChar']."%'";
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<img src=\"./imagens/crown.png\" width=\"11\" height=\"11\"> = HERO<BR /><br><table border=\"0\"
              cellspacing=\"1\"
              cellpadding=\"2\"
       ...
       $cor= $cor == 'c0c0c0' ? 'f0f0f0' : 'c0c0c0';
		...
		$resultaCC= $fetchCC['0'];
		 ...
		 if (mysql_num_rows($hero))
			   {
			   echo " <img src=\"./imagens/crown.png\" title=\"Hero\" width=\"11\" height=\"11\"> ";
			   }
			   else
			   {
			   echo "";
...
{
echo "<br><b>Nenhum Char localizado!<br><br><a href=\"./index.php?t=chars.php\">Voltar</a></b>";
}
