...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="49%" align="left" valign="top"><?php echo "<form action=\"./principal.php?t=editclanname.php\" method=\"POST\">"; 
    ...
    <td width="51%" align="left" valign="top"><?php echo "<form action=\"./principal.php?t=editclanally.php\" method=\"POST\">";
	     echo "Ally: <b>";
		 if ($dato['ally_name'] != '')
		 {
		 echo $dato['ally_name'];
  ...
  <tr>
    <td align="left" valign="top"><?php   echo "<form action=\"./principal.php?t=editclanlevel.php\" method=\"POST\">";
	echo "Level: <b>"; 
	echo $dato['clan_level'];
	echo "<input type=\"hidden\" name=\"clanId\" value=\"{$dato['clan_id']}\">
	<input type=\"hidden\" name=\"clanLevel\" value=\"{$dato['clan_level']}\">
				<input type=\"submit\" value=\"Editar\"></form>";?></td>
    <td align="left" valign="top"><?php  echo "<form action=\"./principal.php?t=editclanleader.php\" method=\"POST\">"; echo "Lider: <b>"; 
  ...
  <tr>
    <td align="left" valign="top"><?php 
	 ...
	 $queryCHN = "SELECT name FROM clanhall WHERE ownerId='{$dato['clan_id']}'";
		...
		$resultaCHID = $fetchCHID['0'];
		 if ($resultaCHN != '')
		 {
		 echo "<form action=\"./principal.php?t=kickoffclanhallsave.php\" method=\"POST\">
		Clan Hall: <b>";
		 echo $resultaCHN; 
		...
		{
		echo "<form action=\"./principal.php?t=getclanhall.php\" method=\"POST\">";
	...
	$queryCS = "SELECT name FROM castle WHERE id='{$dato['hasCastle']}'";
		...
		if ($resultaCS != '')
		{
echo "<form action=\"./principal.php?t=kickoffcastlesave.php\" method=\"POST\">Castelo: <b>";
		...
		{
		 echo "<form action=\"./principal.php?t=giveclancastle.php\" method=\"POST\">Castelo: <b> Sem Castelo </b>
		 <input type=\"hidden\" name=\"clanId\" value=\"{$dato['clan_id']}\">
		<input type=\"hidden\" name=\"clanName\" value=\"{$dato['clan_name']}\">
  ...
  <tr>
    <td align="left" valign="top"><?php 	echo "<form action=\"./principal.php?t=editclanrept.php\" method=\"POST\">";
	...
	echo "<form action=\"./principal.php?t=editclanpenal.php\" method=\"POST\">";
       ...
       }else
{
       ...
       $cor= $cor == 'c0c0c0' ? 'f0f0f0' : 'c0c0c0';
              ...
              <td>
			   ...
			   <td><form action=\"./principal.php?t=detalhesclan.php\" method=\"POST\">
...
?></td>
      <td width="50%" align="center" valign="top">SKILLS:<br />
          <?php
echo "<form action=\"./principal.php?t=addclanskill.php\" method=\"POST\">
