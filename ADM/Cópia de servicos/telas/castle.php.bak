...
\"style15
\" bgcolor=\"{$bg}\">
    <td align=\"center\"><form action=\"./principal.php?t=kickoffcastlesave.php\" method=\"POST\"> {$c['name']}
...
\" bgcolor=\"{$bg}\">
    ...
    <td align=\"center\"><form action=\"./principal.php?t=givecastle.php\" method=\"POST\">
