...
Localizar Clan pelo Nome:
  ...
  <tr>
    <td><a href="./index2.php?t=accounts.php">Accounts:
      <?php 
...
mysql_select_db($server_db,$link) or die('Erro na base');   
	...
	<a href="./index2.php?t=chars.php">Chars Online:
      <?php 
	$link= mysql_connect($db_loc_ip,$server_log,$server_psw) or die('Erro ao conectar no MySQL');
mysql_select_db($server_db,$link) or die('Erro na base');   
...
\" bgcolor=\"{$bg}\">
	...
	<td bgcolor=\"#ffffff\" valign=\"middle\"><form action=\"./index2.php?t=detalheschar.php\" method=\"POST\">
...
\" bgcolor=\"{$bg}\">
	...
	<td bgcolor=\"#ffffff\" valign=\"middle\"><form action=\"./index2.php?t=unbanaccount.php\" method=\"POST\">
