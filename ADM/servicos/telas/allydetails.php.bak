...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="49%" align="left" valign="top"><?php echo "<form action=\"./index2.php?t=editallyname.php\" method=\"POST\">"; 
       ...
       }else
{
       ...
       $cor= $cor == 'c0c0c0' ? 'f0f0f0' : 'c0c0c0';
              ...
              <td>
			   ...
			   <td><form action=\"./index2.php?t=allydetails.php\" method=\"POST\">
...
echo "</table>";
?>
<form action="./index2.php?t=allydetails.php" method="POST">
