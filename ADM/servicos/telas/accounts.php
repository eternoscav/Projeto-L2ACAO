<form action="./index2.php?t=accounts.php" method="POST">
Localizar Account:
...
echo "<table width=\"100%\" border=\"0\">
  <tr class=\"style2\">
  <td align=\"center\"><a href=\"./index2.php?t=accounts.php\">Total de Accounts no Servidor: <strong>{$contarALL} <br></a></strong>
		</td></tr>
</table>";
}
else
       ...
       $cor= $cor == 'c0c0c0' ? 'f0f0f0' : 'c0c0c0';
             ...
             <tr bgcolor=\"$cor\">
              ...
              <td>
			   ...
			   {			   
		 echo "<td><form action=\"./index2.php?t=accounts.php\" method=\"POST\">
