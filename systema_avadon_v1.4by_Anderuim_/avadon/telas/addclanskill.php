       ...
       }else
{
       ...
       $cor= $cor == 'c0c0c0' ? 'f0f0f0' : 'c0c0c0';
              ...
              <td>
			   ...
			   <td><form action=\"./principal.php?t=addclanskill.php\" method=\"POST\">
			   <input type=\"hidden\" name=\"cskillIdDe\" value=\"{$data['skill_id']}\" >
				<input type=\"hidden\" name=\"clanid\" value=\"{$_POST['clanid']}\">
				<input type=\"submit\" value=\"Deletar\">
			   </form></td><td><form action=\"./principal.php?t=addclanskill.php\" method=\"POST\">
...
echo "<br><form action=\"./principal.php?t=addclanskill.php\" method=\"POST\">";
