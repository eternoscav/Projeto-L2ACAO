...
echo "<form action=\"./principal.php?t=editclanallypenal.php\" method=\"POST\">
...
echo "<form action=\"./principal.php?t=editclancharpenal.php\" method=\"POST\">
...
echo "<form action=\"./principal.php?t=editclandisspenal.php\" method=\"POST\">
...
echo "<form action=\"./principal.php?t=editclanallyzeropenal.php\" method=\"POST\">
