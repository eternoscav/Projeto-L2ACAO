<form action="./principal.php?t=conschars.php" method="POST">
...
echo "<table width=\"100%\" border=\"0\">
  <tr class=\"style2\">
  <td align=\"center\"><a href=\"./principal.php?t=allchars.php\">Total de Chars no Servidor: <strong>{$contarALL} <br></a></strong>
		</td></tr><tr><td><br></td></tr><tr>
    <td align=\"center\"><a href=\"./principal.php?t=chars.php\">Chars Online no Servidor: <strong>{$contarON}</strong></td></tr>
</table>";
}
else
{
