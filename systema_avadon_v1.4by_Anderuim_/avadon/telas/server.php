...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="71%" rowspan="6"><form action="./principal.php?t=conschars.php" method="POST">
Localizar Char pelo Nome:
				
				
				<input type="text" name="nomeChar" size="15" /><input type="submit" value="Localizar">
    </form><form action="./principal.php?t=clans.php" method="POST">
Localizar Clan pelo Nome:
  ...
  <tr>
    <td><a href="./principal.php?t=accounts.php">Accounts:
      <?php 
...
mysql_select_db($server_db,$link) or die('Erro na base');   
	...
	<a href="./principal.php?t=chars.php">Chars Online:
      <?php 
	$link= mysql_connect($db_loc_ip,$server_log,$server_psw) or die('Erro ao conectar no MySQL');
mysql_select_db($server_db,$link) or die('Erro na base');   
	$totcharson=("SELECT * FROM characters WHERE online='1'");
		...
		?>
    </a><BR /> <a href="./principal.php?t=allchars.php">Total Chars:
<?php 
...
<a href="./principal.php?t=clans.php">Clans: <b>
...
?>
  ...
  <tr>
    <td><a href="./principal.php?t=clanhall.php"></a></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
\" bgcolor=\"{$bg}\">
	...
	<td bgcolor=\"#ffffff\" valign=\"middle\"><form action=\"./principal.php?t=detalheschar.php\" method=\"POST\">
...
\" bgcolor=\"{$bg}\">
	...
	<td bgcolor=\"#ffffff\" valign=\"middle\"><form action=\"./principal.php?t=unbanaccount.php\" method=\"POST\">
